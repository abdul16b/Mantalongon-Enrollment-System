        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                <div class="sidebar-header">
                    ...
                    <h5><b>NONE-ADVISORY TEACHER</b></h5>
                </div>

                <ul class="list-unstyled components">

                    <li>
                        <a href="/none-advisory/{{$schoolyear}}" class="active text {{ $nav == 'non_advisory' ? 'active-nav' : '' }}"><i
                                class="bi bi-journal-bookmark"></i>
                            &nbsp; Subjects</a>
                    </li>

                    <li>
                        <a href="/none-advisory-schedule/{{$schoolyear}}"
                            class="text {{ $nav == 'subject_teacher_schedule' ? 'active-nav' : '' }}"><i
                                class="bi bi-card-checklist"></i>&nbsp; Schedule</a>
                    </li>

                    <li>
                        <a href="/files/{{$schoolyear}}" class="text {{ $nav == 'files' ? 'active-nav' : '' }}"><i
                            ...
                            <div class="justify-content-end">
                                <ul style="margin-top: 14px; float: right">
                                    ...
                                    <ul class="collapse list-unstyled" id="profile-content"
                                        ...
                                        <li>
                                            <a href="/none-advisory/profile/{{Auth::user()->id}}" class="text"
                                                style="font-size:16px"> Profile Settings</a>
                                        </li>
                                        <li>
                                            <a href="/non_advisory/{{Auth::user()->id}}" class="text"
