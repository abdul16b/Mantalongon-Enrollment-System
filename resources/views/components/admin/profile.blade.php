    ...
    <div class="d-flex justify-content-center" style="margin-top: 120px">
        <div class="card shadow " style="width: 400px">
            @if (Session::has('errorMessage'))
                <p class="alert alert-danger text-center">{{ Session::get('errorMessage') }}</p>
            @endif
                ...
                <div class="card-header">
                    <div class="d-flex bd-highlight">
                        ...
                        <div class="p-2 flex-fill bd-highlight">
                            <h4 style="color:green"> <b>ADMIN PROFILE</b> </h4>
                        </div>
                        <div class="p-2 flex-fill bd-highlight"><a href="{{ url('/admin-dashboard') }}" type="button"
            ...
            <div class="card-body ">
                ...
                <div class="mb-5">
                    ...
                    <div class="mb-3">
                        <div class="form__group field" style=" width: 355px">
                            <input type="number" class="form__field" id="Contact Number" value="{{ $contactnum }}"
                                disabled>
                    ...
                    <div class="mb-3">
                        <div class="form__group field" style=" width: 355px">
                            <div class="password">
                                ...
                                <label class="form__label"><b>Change Password:</b> </label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('components.admin.profile.change') }}">
                                @csrf
                                    ...
                                    <div class="container">
                                        <div class="mb-3">
                                            <div class="form__group field" style=" width: 450px">
                                                <input type="password" class="form__field password" name="current"
                                        ...
                                        <div class="mb-3">
                                            <div class="form__group field" style=" width: 450px">
                                                <input type="password" class="form__field" name="new"
                                                    id="newpassword" required>
                                                <label class="form__label"><b>New Password: </b> <i
                                                        class="bi bi-eye-slash" id="toggleNewPassword"
                                                        style=" cursor: pointer;"></i></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form__group field" style=" width: 450px">
                                                <input type="password" class="form__field" name="confirm"
                                                    id="confirmpassword" required>
                                                <label for="password" class="form__label"><b>Confirm Password: </b>
