...
@section('content')
    @foreach ($students as $student)
        <div class="container p-4" style="overflow-x: hidden; overflow-y:auto;height:470px">
            <form
                action="{{ route('update.studentDetails', ['LRN' => $student->LRN, 'schoolyear' => $student->school_year]) }}"
                method="post">
                @csrf
                <div class="shadow">
                    ...
                    <div class="d-flex bd-highlight mb-4">
                        <div class="p-2 flex-fill bd-highlight">
                            <a href="/student-list/{{$schoolyear}}"><i class="bi bi-arrow-left-circle-fill"
                        ...
                        <div class="p-2 flex-fill bd-highlight" style="width: 1%;">
                            <div class="text-end">
                                <a href="{{ route('edit.adminStudent', ['id'=>$student->id,'LRN' => $student->LRN, 'schoolyear' => $student->school_year]) }}"
                    ...
                    <form action="/junior-high/student-details/{{ $student->LRN }}" method="POST">
                        ...
                        <div class="row mx-2 mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="form__group field" style=" width: 300px">
                                    <input type="text" name="PSA_num" value=" {{ $student->PSA_num }}"
                                        class="form__field" readonly>
                            ...
                            <div class="col">
                                <div class="form__group field" style=" width: 200px">
                                    <input style="max-width:290px;" type="text"
                                        ...
                                        id="address" value="{{ $student->address }}" readonly>
