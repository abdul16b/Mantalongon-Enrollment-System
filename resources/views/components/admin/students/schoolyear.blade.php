                ...
                <tbody>
                    @foreach ($schoolyear as $val)
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{route('show.students', ['schoolyear'=> $val->schoolyear])}}" class=""><i class="bi bi-box-arrow-right"
                                        style="font-size: 25px" data-bs-toggle="tooltip" data-bs-placement="right"
                                        title="OPEN"></i> </a>
                            </td>
                        </tr>
                    @endforeach
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/school-year') }}" method="post">
                        @csrf
                        <select id="ddlYears" style="width: 100%" name="schoolyear" value='{{old('school_year')}}'> </select>
