...
@section('content')
    <div class="container scroll" style="overflow-x: hidden; overflow-y:auto;height:470px">
        ...
        <!-- Fields for form -->
        <form action="{{ route('adviser-admission.store', ['schoolyear' => $schoolyear]) }}" method="POST">
            @csrf
            <div class="row mx-2">
                ...
                <div class="col-md-4 mb-4">
                    <div class="form__group field" style=" width: 300px">
                        <input style="max-width:290px;" type="date"
                            class="form__field @error('date_of_birth') is-invalid @enderror" name="date_of_birth"
        ...
        $(document).ready(function() {
            ...
            $('#gradelevel').change(function() {
                ...
                if (gradelvl) {
                    $.ajax({
                        type: "GET",
                        url: "/getadviserSection/" + gradelvl + "/" + schoolyear,
