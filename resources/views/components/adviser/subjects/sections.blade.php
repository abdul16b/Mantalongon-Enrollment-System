            ...
            @foreach ($sections as $section)
                <div class="col">
                    <div class="card shadow " style="width: 18rem;">
                        ...
                        <a href="{{ route('subject.list', ['gradelevel' => $section->gradeLevel, 'section' => $section->section, 'subject' => $section->subject, 'schoolyear' => $schoolyear]) }}"
                            class="btn btn-success openButton " style="width: 100%"> <i
