...
@section('content')
    @foreach ($students as $student)
        <div class="container p-4" style="overflow-x: hidden; overflow-y:auto;height:470px">
            <form action="{{ route('update.adviserStudent', ['id' => $student->id, 'schoolyear' => $student->school_year]) }}"
                method="POST">
                @csrf
                @method('PATCH')
                <div class="shadow">
                    <div class="d-flex bd-highlight mb-4">
                        <div class="p-2 flex-fill bd-highlight">
                            <a href="/adviser-studentlist/{{$student->id}}/{{ $student->LRN }}/{{ $student->school_year }}"><i
                    ...
                    <div class="row mx-2 mb-3">
                        <div class="col-md-4">
                            <div class="form__group field" style=" width: 300px">
                                <input type="text" name="LRN" id="LRN" value="{{ $student->LRN }}" class="form__field" readonly>
                    ...
                    {{-- <input type="text" name="subjects" id="subjects" value="{{ $student->subjects }}" hidden> --}}
