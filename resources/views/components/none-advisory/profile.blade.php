            ...
            <div class="text-center">
                <div class="card-header">
                    <div class="d-flex bd-highlight">
                        ...
                        <div class="p-2 flex-fill bd-highlight"><a href="/non_advisory/{{Auth::user()->id}}" type="button"
                                class="btn-close justify-content-center" aria-label="Close"></a></div>
                    </div>
                </div>
                <div class="card-header">
                    ...
                    <div class="mb-5">
                        <div class="form__group field" style=" width: 355px">
                            <input type="text" class="form__field" id="name"
                                value=" {{ $profile->firstname .' '. $profile->middlename . ' ' . $profile->lastname }}" disabled>
                            <label class="form__label"><b>Name:</b> </label>
                        </div>

                        <div class="mb-3">
                            <div class="form__group field" style=" width: 355px">
                                <input type="text" class="form__field" id="username" value="{{ $profile->username }}"
                                    disabled>
                        ...
                        <div class="mb-3">
                            <div class="form__group field" style=" width: 355px">
                                <input type="number" class="form__field" id="Mobile Number"
                                    value="{{ $profile->contact }}" disabled>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('components.none-advisory.profile.change') }}">
                    @csrf
                        ...
                        <div class="container">
                            ...
                            <div class="mb-3">
                                <div class="form__group field" style=" width: 450px">
                                    <input type="password" id="currentpassword" class="form__field" name="current">

                                    <label class="form__label"><b>Current Password:</b> <i class="bi bi-eye-slash"
                                            id="toggleCurrentPassword" style="cursor: pointer;"></i> </label>
                                </div>
                            </div>
                            <div class="mb-3">
                                <div class="form__group field" style=" width: 450px">
                                    <input type="password" id="newpassword" class="form__field" name="new">
                            ...
                            <div class="mb-3">
                                <div class="form__group field" style=" width: 450px">
                                    <input type="password" id="confirmpassword" class="form__field" name="confirm">
