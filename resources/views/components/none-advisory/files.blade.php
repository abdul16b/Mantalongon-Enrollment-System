...
@section('content')
    <div class="container p-5">
        <div class="row mb-2" style="margin-top: -14px">
            <div class="col">
            ...
            <div class="col">
                <div class="ms-auto p-2 bd-highlight" style=" width: 90%">
                    ...
                    @if (Auth::user()->id == $file->user_id)
                        <tr>
                            ...
                            <td class="text-end"><a href="/teacher-files/{{ $file->id }}/viewFile"
                                ...
                                <a href="/files/{{ $file->id }}/deleteDocument" class="deletebtn"><i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('files.storeSubTeacher') }}" method="post" enctype="multipart/form-data">
                        @csrf
